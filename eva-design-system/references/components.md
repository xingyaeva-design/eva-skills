...
.number-card {
  ...
  border-radius: 4px;
  overflow: hidden;
  border: 0.5px solid var(--bg-deeper);
}
...
```css
.number-card:nth-child(3n+1) .card-number { color: rgba(138, 158, 146, 0.08); }
.number-card:nth-child(3n+2) .card-number { color: rgba(196, 168, 130, 0.15); }
.number-card:nth-child(3n) .card-number { color: rgba(94, 122, 106, 0.1); }
```
...
/* pill颜色变体 */
.tag-card .card-pill--blue { background: rgba(138,158,146,0.1); color: var(--green); }
.tag-card .card-pill--yellow { background: rgba(196,168,130,0.25); color: #9a8100; }
.tag-card .card-pill--red { background: rgba(94,122,106,0.1); color: var(--green-deep); }
.tag-card .card-title {
  font-family: var(--font-cn);
  font-size: 1.05rem;
  font-weight: 500;
...
/* icon区颜色变体 */
.icon-card .card-icon-area--blue { background: rgba(138,158,146,0.06); }
.icon-card .card-icon-area--yellow { background: rgba(196,168,130,0.12); }
.icon-card .card-icon-area--red { background: rgba(94,122,106,0.06); }
...
.quote-handwrite {
  position: relative;
  padding: 28px 24px;
  border: 2px dashed rgba(138,158,146,0.25);
  border-radius: 4px;
  background: white;
}
...
.quote-highlight .quote-title {
  ...
  margin-bottom: 12px;
  display: inline;
  background: linear-gradient(to top, rgba(196,168,130,0.5) 45%, transparent 45%);
  line-height: 1.8;
  padding: 2px 4px;
}
...
.quote-terminal .dot:nth-child(1) { background: var(--green-deep); }
.quote-terminal .dot:nth-child(2) { background: var(--gold); }
...
.quote-minimal .quote-body .hl {
  background: linear-gradient(transparent 60%, rgba(196,168,130,0.3) 60%);
  padding: 0 4px;
}
...
.quote-note {
  ...
  background: white;
  border-radius: 4px;
  border: 1.5px dashed rgba(138, 158, 146, 0.3);
}
.quote-note-tag {
  position: absolute;
  top: -10px;
...
.quote-note p {
  font-size: 0.93rem;
  line-height: 1.85;
  color: var(--ink-light, var(--ink-mid));
}
```
...
.code-notebook .code-holes {
  ...
  bottom: 0;
  width: 1px;
  background: rgba(94,122,106,0.2);
}
...
.code-notebook pre {
  ...
  background-image: repeating-linear-gradient(
    transparent, transparent 31px, rgba(138,158,146,0.05) 31px, rgba(138,158,146,0.05) 32px
  );
}
```

**语法高亮色**: `.kw { color: var(--green); font-weight: 500; }` `.str { color: var(--green-deep); }` `.cm { color: var(--ink-light); }`
...
.code-typewriter .kw { color: var(--green); text-decoration: underline; text-underline-offset: 3px; }
.code-typewriter .str { color: var(--green-deep); }
.code-typewriter .cm { color: var(--ink-light); font-style: italic; }
...
.code-clean .kw { color: var(--green); font-weight: 600; }
.code-clean .fn { color: #7c3aed; }
.code-clean .str { color: var(--green-deep); }
.code-clean .cm { color: #94a3b8; }
.code-clean .highlight-line {
  background: rgba(138,158,146,0.06);
  margin: 0 -32px;
  padding: 0 32px;
...
.chair-number-card:nth-child(1) .chair-big-num { color: rgba(138,158,146,0.08); }
.chair-number-card:nth-child(2) .chair-big-num { color: rgba(196,168,130,0.15); }
.chair-number-card:nth-child(3) .chair-big-num { color: rgba(94,122,106,0.08); }
...
.chair-dashed-card:nth-child(1) { border-color: rgba(138,158,146,0.3); }
.chair-dashed-card:nth-child(2) { border-color: rgba(196,168,130,0.5); }
.chair-dashed-card:nth-child(3) { border-color: rgba(94,122,106,0.3); }
...
.chair-dashed-card:nth-child(1) .chair-label { color: var(--green); }
.chair-dashed-card:nth-child(2) .chair-label { color: #9a8100; }
.chair-dashed-card:nth-child(3) .chair-label { color: var(--green-deep); }
...
.chair-gradient-card:nth-child(1) { background: linear-gradient(145deg, rgba(138,158,146,0.08), rgba(138,158,146,0.02)); }
.chair-gradient-card:nth-child(2) { background: linear-gradient(145deg, rgba(196,168,130,0.15), rgba(196,168,130,0.03)); }
.chair-gradient-card:nth-child(3) { background: linear-gradient(145deg, rgba(94,122,106,0.08), rgba(94,122,106,0.02)); }
...
.chair-typo-card:nth-child(1) .chair-divider { background: var(--green); }
.chair-typo-card:nth-child(2) .chair-divider { background: var(--gold); }
.chair-typo-card:nth-child(3) .chair-divider { background: var(--green-deep); }
.chair-typo-card h3 {
  font-family: var(--font-en);
  font-size: 1.3rem;
  font-weight: 600;
...
.system-flow {
  ...
  background: var(--bg);
  border-radius: 4px;
  border: 1px solid rgba(138, 158, 146, 0.1);
}
.system-flow span {
  font-size: 0.9rem;
  padding: 6px 14px;
...
.compare-block--dont .compare-header { border-color: var(--green-deep); }
.compare-block--do .compare-header { border-color: var(--green); }
...
.compare-block--dont .compare-label { color: var(--green-deep); }
.compare-block--do .compare-label { color: var(--green); }
.compare-block ul {
  list-style: none;
  padding: 0;
  display: flex;
...
.compare-block--dont li::before { content: '×'; position: absolute; left: 0; color: var(--green-deep); font-weight: 500; }
.compare-block--do li::before { content: '✓'; position: absolute; left: 0; color: var(--green); font-weight: 500; }
```
...
.compare-col-title--dont { color: var(--green-deep); }
.compare-col-title--do { color: var(--green); }
...
.compare-stamp-col--dont { border-color: var(--green-deep); }
.compare-stamp-col--do { border-color: var(--green); }
...
.compare-stamp-col--dont .compare-stamp-label { color: var(--green-deep); }
.compare-stamp-col--do .compare-stamp-label { color: var(--green); }
...
.category-badge {
  ...
  border-radius: 4px;
  font-size: 0.7rem;
  background: rgba(138,158,146,0.1);
  color: var(--green);
...
.tag {
  ...
  border-radius: 8px;
  font-size: 0.7rem;
  background: var(--cream-dark, var(--bg-deep));
}
```
...
.cta-button:hover {
  ...
  box-shadow: 0 8px 24px rgba(138,158,146,0.3);
}
```

**变体**: 黄色CTA — `background: var(--gold); color: var(--ink);`
...
.dot-row:nth-child(2n) .dot-dim::before { background: var(--green); }
.dot-row:nth-child(3n) .dot-dim::before { background: var(--green-deep); }
.dot-val {
  font-size: 0.9rem;
  color: var(--ink, var(--ink));
}
...
.masthead {
  font-family: 'Playfair Display', var(--font-cn);
...
.film-title {
  font-family: 'Instrument Serif', var(--font-en);
...
.hscroll-card .hscroll-num {
  position: absolute; top: 16px; right: 20px; font-family: var(--font-cn);
  font-size: 2rem; color: var(--accent-light, #d4a06a); opacity: 0.4;
}
.hscroll-card h3 { font-size: 1.1rem; font-weight: 500; margin-bottom: 12px; }
.hscroll-card p { font-size: 0.82rem; color: var(--ink-light, #5a4f3f); line-height: 1.9; }
.hscroll-hint { font-size: 0.75rem; color: var(--ink-faint, #8a7e6d); margin-top: 1rem; font-family: var(--font-cn); }
```
...
.tab-item.active { border-bottom-color: var(--accent, #8b4513); color: var(--ink, #2c2416); font-weight: 500; }
.tab-item:hover { color: var(--ink-light, #5a4f3f); }
.tab-panels { position: relative; }
.tab-panel { display: none; animation: tabFadeIn 0.3s; }
.tab-panel.active { display: block; }
.tab-panel h3 { font-size: 1.3rem; font-weight: 500; margin-bottom: 12px; }
.tab-panel p { font-size: 0.88rem; color: var(--ink-light, #5a4f3f); line-height: 2; max-width: 550px; }
.tab-example { margin-top: 1rem; background: #fff; border-radius: 4px; padding: 16px 20px; font-size: 0.9rem; color: var(--accent, #8b4513); border-left: 3px solid var(--accent-light, #d4a06a); }
...
.accordion-step {
  ...
  color: #fff; font-size: 0.8rem; font-weight: 500; display: flex; align-items: center; justify-content: center; flex-shrink: 0;
}
.accordion-header h4 { font-size: 0.95rem; font-weight: 500; }
...
.carousel-slide h3 { font-size: 1.4rem; font-weight: 500; margin-bottom: 16px; }
...
.stack-card h3 { font-size: 1.2rem; font-weight: 500; margin-bottom: 12px; }
...
.stack-hint { font-size: 0.75rem; color: var(--ink-faint, #8a7e6d); text-align: center; margin-top: 3.5rem; font-family: var(--font-cn); }
```
...
.reveal-card {
  ...
  border-radius: 8px; box-shadow: 0 4px 20px rgba(0,0,0,0.05); overflow: hidden;
}
.reveal-text {
...
.reveal-overlay {
  ...
  padding: 40px; opacity: 0; transition: opacity 0.4s ease; z-index: 3; border-radius: 8px;
}
...
.dark-reveal-btn {
  ...
  background: transparent; color: var(--accent-light, #d4a06a); border-radius: 8px;
...
.split-qa-left h2 { font-family: var(--font-cn); font-weight: 600; font-size: clamp(1.8rem, 4vw, 2.5rem); margin-bottom: 1.5rem; }
...
.split-qa-num {
  ...
  color: #fff; font-size: 0.75rem; font-weight: 500; flex-shrink: 0;
...
.split-qa-right h3 { font-size: 0.85rem; font-weight: 500; color: var(--accent, #8b4513); margin-bottom: 12px; }
.split-qa-flow { display: flex; align-items: center; flex-wrap: wrap; gap: 8px; }
.split-qa-step { background: var(--cream-dark, #f0e9dc); padding: 6px 14px; border-radius: 8px; font-size: 0.78rem; color: var(--ink-light, #5a4f3f); }
...
.numgrid-card::before {
  ...
  font-family: var(--font-cn); font-size: 3rem; color: var(--accent-light, #d4a06a); opacity: 0.2;
}
.numgrid-card h4 { font-size: 0.82rem; font-weight: 500; margin-bottom: 6px; color: var(--accent, #8b4513); }
...
.postcard-body {
  font-family: var(--font-cn); font-size: 1.05rem; line-height: 2.8;
  color: var(--ink-light, #5a4f3f);
}
.postcard-num { color: var(--accent, #8b4513); font-weight: 500; }
...
.postcard-stamp {
  position: absolute; bottom: -12px; right: 24px; font-family: var(--font-cn);
...
<div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 14px; max-width: 760px;">
  <div class="work-card" onclick="openModal(0)" style="border-radius: 4px; overflow: hidden; cursor: pointer; position: relative; aspect-ratio: 16/10;">
    <img src="[image-url]" style="width: 100%; height: 100%; object-fit: cover; transition: transform 0.4s;">
    <div style="position: absolute; top: 12px; right: 12px; background: rgba(255,255,255,0.15); backdrop-filter: blur(4px); padding: 4px 10px; border-radius: 4px; font-size: 0.6rem; color: #fff;">Click to explore →</div>
    <div style="position: absolute; bottom: 0; left: 0; right: 0; padding: 16px 18px; background: linear-gradient(to top, rgba(0,0,0,0.8), transparent); color: #fff;">
      <h3 style="font-size: 0.9rem; font-weight: 500;">Project Name</h3>
...
<div class="modal-overlay" id="modal" onclick="closeModal(event)" style="display: none; position: fixed; inset: 0; z-index: 1000; background: rgba(0,0,0,0.88); align-items: center; justify-content: center; padding: 24px;">
  ...
  <div style="background: #F5F5F0; border-radius: 8px; max-width: 900px; width: 100%; max-height: 90vh; overflow-y: auto;" onclick="event.stopPropagation()">
    <img src="[hero-image]" style="width: 100%; aspect-ratio: 21/9; object-fit: cover; border-radius: 8px 16px 0 0;">
...
```html
<div style="display: flex; gap: 0; max-width: 850px; height: 420px; border-radius: 4px; overflow: hidden; box-shadow: 0 8px 30px rgba(0,0,0,0.08);">
  <!-- Thumbnail rail -->
...
<div style="display: grid; grid-template-columns: repeat(4, 1fr); gap: 14px; max-width: 800px; perspective: 1200px;">
  <div style="aspect-ratio: 3/4; position: relative; cursor: pointer;">
    <div class="flip-inner" style="width: 100%; height: 100%; position: relative; transition: transform 0.6s; transform-style: preserve-3d; border-radius: 4px;">
      <!-- Front -->
      <div style="position: absolute; inset: 0; backface-visibility: hidden; border-radius: 4px; overflow: hidden;">
      ...
      <!-- Back -->
      <div style="position: absolute; inset: 0; backface-visibility: hidden; transform: rotateY(180deg); background: #2C2A26; border-radius: 4px; padding: 20px; display: flex; flex-direction: column; justify-content: center; color: #fff;">
        <h4 style="font-size: 0.85rem; font-weight: 500;">Title</h4>
...
## Eva 品牌组件库 — v2（从 signal · editorial-forest 提炼）

> 以下组件已适配 Eva 品牌色系（月白+烟绿+暖金），可直接复制使用。
> CSS 变量依赖 brand-dna.md 中的 `:root` 定义。

---

### E1. 深色时间线（Dark Timeline）

适用场景：OKR 路线图、项目里程碑、个人历程、Phase 展示

```html
<div class="c-timeline">
  <div class="tl-eyebrow">Roadmap · 路线图</div>
  <h2 class="tl-headline">标题文字</h2>
  <div class="vtimeline">
    <div class="vt-date">2026.05–08</div>
    <div class="vt-spine"></div>
    <div class="vt-content">
      <div class="vt-title">Phase 1 · 筑基</div>
      <div class="vt-body">描述内容</div>
    </div>
    <!-- 重复以上三格添加更多节点 -->
  </div>
</div>
...
.tl-eyebrow {
  font-family: sans-serif; font-size: 0.62rem; letter-spacing: 0.2em;
  text-transform: uppercase; color: var(--green);
  margin-bottom: 28px; display: flex; align-items: center; gap: 10px;
}
.tl-eyebrow::before { content:''; width:20px; height:1px; background: var(--green); }
.tl-headline {
  font-family: var(--font-en); font-size: clamp(1.6rem,3vw,2.4rem);
  font-weight: 300; color: #F0EDE6; line-height: 1.2;
  padding-bottom: 28px;
  border-bottom: 1px solid rgba(190,181,162,0.15);
}
.vtimeline {
  display: grid; grid-template-columns: 7em 1px 1fr;
  gap: 0; padding-top: 4px;
}
.vt-date {
  font-family: sans-serif; font-size: 0.6rem; letter-spacing: 0.1em;
  color: var(--gold); text-align: right;
  padding: 1.1em 1.5em 3em 0; line-height: 1.4;
}
.vt-spine {
  background: rgba(190,181,162,0.2); position: relative;
}
.vt-spine::before {
  content: ''; position: absolute; top: 1em; left: -4px;
  width: 9px; height: 9px; border-radius: 50%;
  background: var(--gold);
}
.vt-content { padding: 0.8em 0 2.8em 1.5em; }
.vt-title {
  font-family: var(--font-en); font-size: 1.1rem; font-weight: 400;
  color: #F0EDE6; margin-bottom: 6px; line-height: 1.3;
}
.vt-body {
  font-family: var(--font-cn); font-size: 0.78rem; font-weight: 300;
  color: rgba(240,237,230,0.5); line-height: 1.8;
}
```

**设计规则**：深色底专用暖金年份/圆点；标题用 Cormorant 轻体；正文 Noto Serif SC 300

---

### E2. 横向步骤流程（Horizontal Step Flow）

适用场景：工作流、Vibe Coding 教程、操作步骤、方法论展示

```html
<div class="c-flow">
  <h2 class="flow-headline">流程标题</h2>
  <div class="flow-row">
    <div class="flow-step">
      <div class="flow-num">01</div>
      <div class="flow-title">步骤标题</div>
      <div class="flow-desc">简短描述</div>
    </div>
...
.flow-headline {
  font-family: var(--font-en); font-size: clamp(1.4rem,2.5vw,2rem);
  font-weight: 300; color: var(--ink); margin-bottom: 36px; line-height: 1.2;
}
...
.flow-num {
  font-family: var(--font-en); font-size: clamp(2rem,4vw,3.2rem);
  font-weight: 300; font-style: italic; line-height: 1;
  color: var(--gold);
}
.flow-title {
  font-family: var(--font-cn); font-size: 0.95rem; font-weight: 500;
...
.flow-arrow {
  display: flex; align-items: flex-start; padding-top: 1em;
  padding-right: 20px; font-size: 1rem; color: var(--sand); flex-shrink: 0;
}
...
**设计规则**：暖金斜体大数字做视觉锚点；箭头用沙金低调连接；步骤 3-5 个最佳

---

### E3. 左文右图两栏（Two-Column Text + Image）

适用场景：项目介绍、案例展示、功能说明、观点+佐证
...
<div class="c-twocol">
  <div class="col-img">
    ...
    <div class="col-img-caption">图注文字</div>
  </div>
  <div class="col-text">
    <div class="col-eyebrow-line"></div>
    <div class="col-eyebrow">Eyebrow Label</div>
    <h2 class="col-title">标题，一句话说清楚核心观点。</h2>
    <p class="col-body">正文段落，支撑标题的论据。</p>
    <div class="col-list">
      <div class="col-list-item">要点一</div>
      <div class="col-list-item">要点二</div>
      <div class="col-list-item">要点三</div>
    </div>
  </div>
</div>
```
...
.col-eyebrow-line { width: 32px; height: 1px; background: var(--green); margin-bottom: 8px; }
.col-eyebrow {
  font-family: sans-serif; font-size: 0.6rem; letter-spacing: 0.2em;
  text-transform: uppercase; color: var(--green); margin-bottom: 20px;
}
.col-title {
  font-family: var(--font-en); font-size: clamp(1.6rem,3.5vw,2.8rem);
  font-weight: 300; line-height: 1.1; color: var(--ink);
  margin-bottom: 24px; letter-spacing: -0.01em;
}
.col-body {
  font-family: var(--font-cn); font-size: 0.88rem; font-weight: 300;
  color: var(--ink-mid); line-height: 2; margin-bottom: 14px;
}
.col-list { margin-top: 8px; display: flex; flex-direction: column; gap: 12px; }
.col-list-item {
  display: flex; align-items: baseline; gap: 14px;
  font-family: var(--font-cn); font-size: 0.82rem; font-weight: 300;
...
.col-img-caption {
  ...
  font-family: sans-serif; font-size: 0.58rem; letter-spacing: 0.12em;
  text-transform: uppercase; color: var(--ink-light);
}
@media (max-width: 768px) {
  .c-twocol { grid-template-columns: 1fr; }
}
```

**设计规则**：图在左文在右（默认）；eyebrow 短线+烟绿文字；列表用破折号不用圆点

---

### E4. 大留白金句页（Big Quote Statement）

适用场景：金句收尾、章节过渡、核心观点强调、演讲文稿关键页

```html
<div class="c-quote">
  <div class="quote-top">
    <div class="quote-eyebrow">The Shift · 关键转变</div>
    <div class="quote-rule"></div>
    <div class="quote-text">
      金句内容，一到两行，<br>斜体衬线，留大量空白。
    </div>
  </div>
  <div class="quote-bottom">
    <div>
      <div class="quote-attr-name">Eva Lan</div>
      <div class="quote-attr-role">角色 · 年份</div>
    </div>
    <div class="quote-section-label">章节标签</div>
  </div>
</div>
```
...
.quote-rule { width: 32px; height: 1px; background: var(--green); margin-bottom: 32px; }
.quote-text {
  font-family: var(--font-en); font-size: clamp(1.8rem,4vw,3.2rem);
  font-weight: 300; font-style: italic; line-height: 1.25;
  color: var(--ink); max-width: 900px; letter-spacing: -0.01em;
}
.quote-bottom {
...
.quote-attr-name {
  ...
  font-style: italic; font-weight: 300; color: var(--ink-mid);
}
.quote-attr-role {
  font-family: sans-serif; font-size: 0.6rem; letter-spacing: 0.14em;
...
**设计规则**：留白是主角，文字不超过两行；底部左右各一个 meta 信息，不要居中

---

> 来源：signal template · editorial-forest template（zarazhangrui/beautiful-html-templates）
> 适配日期：2026.05
